        ...
        <div className="w-full max-w-7xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="lg:pr-12 xl:pr-20">
            <h1 className="text-6xl md:text-8xl py-5 font-black leading-tight mb-10 tracking-tighter animate__animated animate__fadeInUp">
              ...
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#59daf4] to-[#b96dd0]">
                for Modern Teams
              </span>
            </h1>
            ...
            >
              ...
              Plan faster, stay aligned, and deliver with complete visibility - without juggling multiple tools.
            </motion.p>
            ...
            >
              <Link to="/signup">
                <button className="group relative px-8 py-4 rounded-full bg-slate-900 text-white font-semibold shadow-2xl hover:shadow-blue-500/20 transition-all hover:-translate-y-1 overflow-hidden">
              ...
              <Link to="/contact">
                <button 
                  ...
                  className={`px-8 py-4 rounded-full backdrop-blur-md border font-semibold transition-all hover:-translate-y-1
                  ${isDark ? 'bg-white/5 border-white/10 text-white hover:bg-white/10' : 'bg-white/40 border-slate-200 text-slate-700 hover:bg-white/60'}`}>
                  Contact Us
                </button>
              </Link>
            </motion.div>
          ...
          <div className="relative w-full h-full flex items-start pt-20 justify-center">
            <motion.div
            ...
            >
              <div className={`relative rounded-[2.5rem] p-5 border backdrop-blur-xl
                ${isDark ? 'bg-slate-800/50 border-slate-700/50' : 'bg-blue-200/30 border-blue-200/30'}`}>
                <img
                  src="https://images.unsplash.com/photo-1460925895917-afdab827c52f?auto=format&fit=crop&w=800&q=80"
                  className="rounded-[2rem] w-full object-cover shadow-lg opacity-95"
                  alt="Dashboard"
                />
              </div>
              ...
              <motion.div
                ...
                className={`absolute -bottom-8 -left-8 p-5 rounded-2xl shadow-xl flex items-center gap-4 border backdrop-blur-md
