       ...
       hover:opacity-90 transition w-auto mx-auto sm:mx-0"
          ...
          <div className="relative flex justify-center lg:justify-end mt-12 lg:mt-0">
            <div className="relative w-[280px] sm:w-[400px] lg:w-[500px] h-[280px] sm:h-[400px] lg:h-[500px]">
              <div className="absolute inset-0 bg-gradient-to-br from-purple-400/50 to-purple-600/30 rounded-full shadow-2xl">
              ...
              {/* Floating Cards */}
              <div className="absolute top-5 right-2 bg-white/95 backdrop-blur-sm rounded-2xl px-6 py-2 shadow-xl border border-white/40">
              ...
              <div className="absolute top-40 -left-10 sm:left-[-20px] bg-white/95 backdrop-blur-sm rounded-2xl px-5 py-4 shadow-xl border border-white/40">
                <div className="flex items-center space-x-3">
              ...
              <div className="absolute bottom-2 right-6 bg-white/95 backdrop-blur-sm rounded-2xl px-5 py-3 shadow-xl border border-white/40">
                <div className="flex items-center space-x-3">
