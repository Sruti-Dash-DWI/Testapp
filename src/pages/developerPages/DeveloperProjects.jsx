  ...
  return (
    ...
    <div className="min-h-screen bg-gradient-to-br p-6 md:p-8">
      ...
      <div className="flex justify-between items-center mb-8">
        ...
        <button 
          onClick={handleShow}
          className="px-6 py-3 bg-teal-600 hover:bg-teal-600 text-white font-medium rounded-lg transition-all duration-300 transform hover:scale-105 flex items-center shadow-lg"
        >
        ...
        {projects.length > 0 ? (
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div key={project.id} className="relative"> {/* Use a relative div as a wrapper */}
              <Link to={`/developer/backlog/${project.id}`} onClick={() => handleProjectClick(project)}>
              <div 
          ...
          <div className="flex flex-col items-center justify-center py-16 px-4 text-center bg-white/5 rounded-2xl backdrop-blur-sm">
            ...
            <p className="text-gray-950 max-w-md">Get started by creating your first project. Click the button above to begin.</p>
          </div>
        ...
        >
          <div 
            ...
            style={{
              ...
              scrollbarWidth: 'thin',
              scrollbarColor: '#14b8a6 rgba(255, 255, 255, 0.1)'
            }}
            ...
            <form onSubmit={handleSubmit} style={{ padding: '24px' }}>
              ...
              <div style={{ marginBottom: '20px' }}>
                ...
                <input
                  ...
                  onFocus={(e) => {
                    ...
                    e.target.style.boxShadow = '0 0 0 2px rgba(20, 184, 166, 0.4)';
                  }}
                  onBlur={(e) => {
              ...
              >
                ...
                <button
                  ...
                  onMouseOut={(e) => {
                    if (!loading) {
                      e.target.style.backgroundColor = 'rgba(20, 184, 166, 0.8)';
