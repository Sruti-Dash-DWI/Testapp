      ...
      <div className="flex items-center space-x-4">
        ...
        {isLoggedIn ? (
          <button 
            ...
            className="hidden rounded-full bg-purple-600 px-6 py-2 font-semibold text-white shadow-lg transition-all duration-200 hover:bg-purple-700 md:block"
          >
            Logout
          </button>
        ) : (
          ...
          <div className="mt-4 border-t border-purple-200 pt-4">
            {isLoggedIn ? (
              <button 
                ...
                className="w-full rounded-full bg-purple-600 py-2 font-semibold text-white"
              >
                Logout
              </button>
            ) : (
