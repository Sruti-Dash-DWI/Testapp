...
const TesterManageTeamModal = ({ project, onClose }) => {
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm" onClick={onClose}>
            <div 
                ...
                style={{ background: "linear-gradient(135deg,rgb(93, 164, 184) 0%,rgb(146, 197, 158) 50%,rgb(181, 247, 202) 100%)"}}
...
export default TesterManageTeamModal;
