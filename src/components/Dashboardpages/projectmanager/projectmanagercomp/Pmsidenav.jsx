...
const PmSideNav = ({ isOpen, openInviteModal, notificationCount }) => {
                    ...
                    <li key={item.name}>
                        ...
                        >
                            ...
                            <div className="relative">
                                ...
                                {!isOpen && item.name === 'Notifications' && notificationCount > 0 && (
                                    <span className="absolute -top-1 -right-1 flex h-2.5 w-2.5 rounded-full bg-red-500 animate-pulse"></span>
                                )}
                            </div>
                            ...
                            {isOpen && item.name === 'Notifications' && notificationCount > 0 && (
                                <span className="ml-auto flex items-center justify-center bg-red-500 text-white text-xs font-bold px-2 py-0.5 rounded-full animate-pulse">
                                    {notificationCount}
                                </span>
                            )}
                        </NavLink>
