// src/components/Dashboardpages/projectmanager/projectmanagercomp/Pmsidenav.jsx
...
const PmSideNav = ({ isOpen, openInviteModal }) => {
    const [projects, setProjects] = useState([]);
    const [isProjectsOpen, setIsProjectsOpen] = useState(false);
    // CHANGED: Use isTeamsOpen instead of isUserMenuOpen to match SideNav structure
    ...
    return (
        ...
        >
            <ul className="flex flex-col gap-4 flex-grow">
                ...
                {/* NEW TEAMS SECTION (Replaces old User Management) */}
                <li>
                    <button 
