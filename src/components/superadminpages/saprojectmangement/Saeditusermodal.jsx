...
const Saeditusermodal = ({ member, onClose, onUpdate, onDeleteSuccess }) => { 
    ...
    const autoSave = useCallback(async (dataToSave) => {
        try {
            ...
            // Ensure consistency with plural 'users'
        ...
        try {
            ...
            if (response.ok) {
               ...
               onClose();
                 ...
                 // Try to read the error message from server if it exists
...
export default Saeditusermodal;