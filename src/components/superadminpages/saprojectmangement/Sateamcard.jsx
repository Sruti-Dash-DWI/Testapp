...
import { Mail, Phone, MessageSquare, Eye ,Building2} from 'lucide-react';
...
const Sateamcard = ({ member, onEdit }) => {
    const { first_name, last_name, role, email, phone, is_active,organization } = member;
        ...
        >
            ...
            <div className="flex-grow">
                ...
                <div className="flex flex-col sm:flex-row items-start sm:items-center gap-y-1 gap-x-5 text-gray-600 text-sm mt-2">
                    ...
                    <a href={`org:${organization}`}className="flex items-center gap-2 hover:text-blue-600 transition-colors"><Building2 size={16}/>{organization?.name || 'N/A'}</a>
                </div>
            </div>
