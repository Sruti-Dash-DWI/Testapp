// src/components/developerDashboardpages/Project management developer/DevEditUserModal.jsx
...
const DevEditUserModal = ({ member, onClose, onUpdate, onDeleteSuccess }) => { 
...
export default DevEditUserModal;